...
// Calendar cell shows peak.band + peak.direction + primeCells. NOT an averaged score.
// Showing the DIRECTION in the month cell is new in v2 and is the cheapest way to
// make the model's premise visible at the calendar level.
```
